const scenes = {
  ...
  'ch2': [
    ...
    [{ sanity: -20, credibility: -10, caffeine: -10, deadline: -10 }, 'ch3'], // changed from -25
  ...
  'ch5': [
    ...
    [{ sanity: -20, credibility: -15, caffeine: -10, deadline: -15 }, 'ch_6'], // changed from -25
  ],
  'ch_6': [
    [{ sanity: -15, credibility: +10, caffeine: -5, deadline: -10 }, 'ch_6_follow'],
    [{ sanity: -10, credibility: -5, caffeine: 0, deadline: -5 }, 'ch_6_follow'],
    [{ sanity: -20, credibility: -15, caffeine: -10, deadline: -15 }, 'ch_6_follow'], // changed from -25
  ],
  'ch_6_follow': [
...
traverse('ch0', { ...INIT });
console.log(`Scenario A — three -25 sanity → -20`);
