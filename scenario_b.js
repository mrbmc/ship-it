const scenes = {
  'ch0': [
    [{ sanity: -10, credibility: +5, caffeine: -10, deadline: -15 }, 'ch1_a'], // caffeine -15 → -10
  ...
  'ch1_c': [
    ...
    [{ sanity: -15, credibility: -5, caffeine: -10, deadline: -5 }, 'ch2'], // caffeine -15 → -10
    [{ sanity: -5, credibility: -10, caffeine: -5, deadline: -10 }, 'ch2'],
  ],
  'ch2': [
    [{ sanity: -15, credibility: -5, caffeine: -5, deadline: -5 }, 'ch3'],
    [{ sanity: -20, credibility: -10, caffeine: -10, deadline: -10 }, 'ch3'], // sanity -25 → -20
    [{ sanity: -15, credibility: +10, caffeine: -10, deadline: -10 }, 'ch3'], // caffeine -15 → -10
  ],
  'ch3': [
  ...
  'ch5': [
    ...
    [{ sanity: -20, credibility: -15, caffeine: -10, deadline: -15 }, 'ch_6'], // sanity -25 → -20
  ],
  'ch_6': [
    [{ sanity: -15, credibility: +10, caffeine: -5, deadline: -10 }, 'ch_6_follow'],
    [{ sanity: -10, credibility: -5, caffeine: 0, deadline: -5 }, 'ch_6_follow'],
    [{ sanity: -20, credibility: -15, caffeine: -10, deadline: -15 }, 'ch_6_follow'], // sanity -25 → -20
  ],
  'ch_6_follow': [
...
traverse('ch0', { ...INIT });
console.log(`Scenario B — three -25 sanity → -20 AND three caffeine -15 → -10`);
